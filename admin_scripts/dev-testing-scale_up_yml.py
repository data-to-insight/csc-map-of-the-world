...
- REL source/target identifiers: slugified org names (e.g., test1)
...
def build_org_payload(idx: int):
    ...
    org_block = {
        ...
        "name": name,
        # Helpful for deterministic relationships; safe if ignored by your pipeline.
        "slug": slugify(name),
        "description": desc,
        ...
        "organization_fields": {
            "organisation_type": "",
            "region": "England",
            "projects": [""],  # renders as a single "-" placeholder
            "persons": [
...
def main():
    ...
    p.add_argument("--id-strategy", choices=["slug", "name", "filestem"], default="slug",
